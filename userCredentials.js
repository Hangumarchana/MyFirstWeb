function loginPanel() {
    ...
    container.innerHTML = `
        <div class="login-panel-con">
            ...
            <img src="facebook%20(3).png" alt="Facebook Icon" class="facebookIcon">
    ...
    showImage.src = "hidden.png";


    showImage.addEventListener("mouseover", function() {
        showImage.src = "eye%20(1).png";
...
function signIn() {
    ...
    <div class="login-panel-con1">
        ...
        <img src="google.png" alt="Google-icon" class="googleIcon1">
        <img src="facebook%20(3).png" alt="Facebook Icon" class="facebookIcon1">
